...
function Home() {
    return (
        <Container>
            <Content>
                <ImageContainer>
                    <img src="/profile2.jpeg" alt="Profile 1" style={imageStyle} />
                </ImageContainer>
                <AnimatedText>
                    <Heading>🙋‍♂️ Hello, I'm Narain!</Heading>
                    <SubHeading>Rising Sophomore at the University of Maryland - College Park, pursuing a Computer Science major</SubHeading>
                </AnimatedText>
            </Content>
            <SVGContainer>
